...
public class AccountsController {
    ...
    public ResponseEntity<ResponseDto> updateAccountDetails(@Valid @RequestBody CustomerDto customerDto){
        ...
        if (isUpdated){
            ...
            return ResponseEntity.status(HttpStatus.EXPECTATION_FAILED).body(new ResponseDto(AccountsConstants.MESSAGE_417_UPDATE,AccountsConstants.MESSAGE_417_UPDATE));
        }
    }
